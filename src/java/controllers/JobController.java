   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      if (action == null) {
         ...
         try {
            ...
            int negotiable = negotiableStr != null && negotiableStr.equals("on") ? 1 : 0;
            ...
            oldJob.setDeadline(deadlineStr != null && !deadlineStr.isEmpty() ? LocalDate.parse(deadlineStr) : null);

            try {
               oldJob.setSalaryMin(salaryMinStr != null && !salaryMinStr.isEmpty() ? Integer.parseInt(salaryMinStr) : 0);
               oldJob.setSalaryMax(salaryMaxStr != null && !salaryMaxStr.isEmpty() ? Integer.parseInt(salaryMaxStr) : 0);
               ...
               oldJob.setNegotiable(negotiableStr != null && negotiableStr.equals("on") ? 1 : 0);
